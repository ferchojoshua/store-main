...
export const getFamiliaByIdAsync = async (id) => {
  const result = { statusResponse: true, data: [], error: null };
  try {
...
export const updateFamiliaByIdAsync = async (data) => {
  const result = { statusResponse: true, data: [], error: null };
...
export const deleteFamiliaAsync = async (id) => {
  const result = { statusResponse: true, data: [], error: null };
  try {
...
export const addFamiliaAsync = async (data) => {
  const result = { statusResponse: true, data: [], error: null };
  try {
