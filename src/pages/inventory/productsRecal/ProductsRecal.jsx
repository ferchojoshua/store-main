...
// // // //   //       const result = await getProductsRecalByIdAsync(token, resultStores.data[0].id);
// // // //   //       if (!result.statusResponse) {
// // // //   //         setIsLoading(false);
// // // //   //         if (result.error.request.status === 401) {
// // // //   //           navigate(`${ruta}/unauthorized`);
...
// // // //      })();
// // // //    }, [reload]);
// // // //       if (resultTipoNegocio.data.length < 0) {
// // // //         setSelectedStore(resultStores.data[0].id);
// // // //       }
      

// // // //        const result = await getProductsAsync(token, resultStores);
// // // //        if (!result.statusResponse) {
// // // //          setIsLoading(false);
// // // //          if (result.error.request.status === 401) {
// // // //            navigate(`${ruta}/unauthorized`);
